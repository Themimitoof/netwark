...
latex_documents = [
    (master_doc, 'Netwark.tex', 'Netwark Documentation',
...
man_pages = [
    (master_doc, 'netwark', 'Netwark Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Netwark', 'Netwark Documentation',
     author, 'Netwark', 'One line description of project.',
     'Miscellaneous'),
]
