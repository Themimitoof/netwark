...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['operation'],
            ['operation.id'],
            name=op.f('fk_operation_result_operation_operation'),
        ),
        sa.PrimaryKeyConstraint('id', name=op.f('pk_operation_result')),
    )

    op.add_column('operation', sa.Column('payload', sa.JSON(), nullable=True))
    op.add_column(
        'operation', sa.Column('queues', sa.String(), nullable=False)
    )
    op.add_column(
        'operation',
        sa.Column(
    ...
    op.add_column(
        'operation', sa.Column('updated_at', sa.TIMESTAMP(), nullable=False)
    )
    op.alter_column(
        'operation',
        'created_at',
